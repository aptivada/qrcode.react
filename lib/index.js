...
var DEFAULT_BGSHAPE = "rect";
var DEFAULT_FGSHAPE = "rect";
var DEFAULT_BORDER_SIZE = 0;
var SPEC_MARGIN_SIZE = 4;
var DEFAULT_MARGIN_SIZE = 0;
var DEFAULT_IMG_SCALE = 0.1;
function isCorner(cellCount, cdx, rdx) {
...
var QRCodeCanvas = import_react.default.forwardRef(function QRCodeCanvas2(props, forwardedRef) {
  ...
  const setCanvasRef = (0, import_react.useCallback)(
    (node) => {
  ...
  (0, import_react.useEffect)(() => {
    if (_canvas.current != null) {
      ...
      const bgPadding = bgShape === "circle" ? circleOffset + borderSize : borderSize / 2;
      ...
      const insideCircle = (x, y) => {
        ...
        return Math.sqrt(Math.pow(c - x - 0.5, 2) + Math.pow(c - y - 0.5, 2)) < r;
      };
...
var shapeMapping = {
  star: {
    fontSize: "1.3pt",
    cb: ({ x, y, unitSize }) => `<text class="react-qrcode-svg" x="${(x + 0.5) * unitSize}" y="${(y + 1) * unitSize}" text-anchor="middle">\u2605</text>`
  },
  heart: {
    fontSize: ".6pt",
    cb: ({ x, y, unitSize }) => `<text class="react-qrcode-svg" x="${(x + 0.5) * unitSize}" y="${(y + 1) * unitSize}" text-anchor="middle">\u2764\uFE0F</text>`
  },
  circle: {
    cb: ({ x, y, unitSize }) => `<circle class="react-qrcode-svg" r="0.5" cx="${(x + 0.5) * unitSize}" cy="${(y + 0.5) * unitSize}" />`
  },
  rect: {
    cb: ({ x, y, unitSize }) => `<rect class="react-qrcode-svg" x="${x * unitSize}" y="${y * unitSize}" width="${unitSize}" height="${unitSize}"/>`
  }
};
function createShapeQRCodeSVG(data, shape, fgColor, offsetX = 0, offsetY = 0) {
  var _a;
  const matrix = data;
  const unitSize = 1;
  ...
  let svgContent = `<style>
    ...
    text.react-qrcode-svg, rect.react-qrcode-svg, circle.react-qrcode-svg {
      ...
      fill:${fgColor != null ? fgColor : "#000000"};
      ${!!((_a = shapeMapping[shape]) == null ? void 0 : _a.fontSize) ? `font-size:${shapeMapping[shape].fontSize};` : ""}
    }
  </style>`;
  const isCornerBox = (x, y) => {
...
var QRCodeSVG = import_react.default.forwardRef(function QRCodeSVG2(props, forwardedRef) {
      ...
      for (let row = 0; row < 10; row++) {
        for (let col = 0; col < cells.length; col++) {
          ...
          [start, end].forEach(({ i, y }) => {
            var _a2, _b2;
            if (cells[i][j] && insideCircle(x, y)) {
              bgShapeSVG += shapeMapping[(_a2 = otherProps.fgShape) != null ? _a2 : "rect"].cb({ x, y, unitSize: 1 });
            }
            if (cells[j][i] && insideCircle(y, x)) {
              bgShapeSVG += shapeMapping[(_b2 = otherProps.fgShape) != null ? _b2 : "rect"].cb({ x: y, y: x, unitSize: 1 });
            }
          });
        }
      }
  ...
  let fgPath = "";
  if (["rect"].includes((_b = otherProps.fgShape) != null ? _b : "")) {
    fgPath = generatePath(cells, margin);
  }
  let shapeQRCodeSVG = "";
  if (["heart", "star", "circle"].includes((_c = otherProps.fgShape) != null ? _c : "")) {
    shapeQRCodeSVG = createShapeQRCodeSVG(cells, otherProps.fgShape, fgColor, margin, margin);
  }
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement("style", null, `
        .react-qrcode-svg.bg{fill:${bgColor != null ? bgColor : "#ffffff"};}
        text.react-qrcode-svg, rect.react-qrcode-svg, circle.react-qrcode-svg {
          font-family: "Courier New";
          fill:${fgColor != null ? fgColor : "#000000"};
          ${!!((_e = shapeMapping[(_d = otherProps.fgShape) != null ? _d : "rect"]) == null ? void 0 : _e.fontSize) ? `font-size:${shapeMapping[(_f = otherProps.fgShape) != null ? _f : "rect"].fontSize};` : ""}
        }
      `),
    bgShape == "rect" && /* @__PURE__ */ import_react.default.createElement(
      "rect",
      {
    ...
    bgShape == "circle" && /* @__PURE__ */ import_react.default.createElement("g", { dangerouslySetInnerHTML: { __html: bgShapeSVG } }),
    ["rect"].includes((_g = otherProps.fgShape) != null ? _g : "") && /* @__PURE__ */ import_react.default.createElement("path", { fill: fgColor, d: fgPath, shapeRendering: "crispEdges" }),
    ["star", "circle", "heart"].includes((_h = otherProps.fgShape) != null ? _h : "") && /* @__PURE__ */ import_react.default.createElement("g", { dangerouslySetInnerHTML: { __html: shapeQRCodeSVG } }),
    image
  );
});
var QRCode = import_react.default.forwardRef(function QRCode2(props, forwardedRef) {
